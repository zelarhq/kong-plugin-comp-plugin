    ...
    describe(PLUGIN_NAME .. ": (access) [#" .. strategy .. "]", function()
        ...
        lazy_setup(function()
            ...
            bp.plugins:insert {
                ...
                config = { destinations = {
                    ...
                    { uri = "https://62c52085a361f725127aecd2.mockapi.io/users", method = "GET" }
                } },
            }
        ...
        describe("response", function()
            it("gets a non empty response", function()
                ...
                -- validate the body
                assert.equal(#respBody, 2) -- Since 2 URIs, expected 2 responses
                ...
                assert.equal(respBody[2].uri, "https://62c52085a361f725127aecd2.mockapi.io/users")
